...
def create_augmented_dataloader(args, dataset):
    ...
    original_train_dataset = tokenized_dataset["train"]

    # Sample 5,000 examples from the original training set and apply custom transformation
    ...
    augmented_dataset = torch.utils.data.ConcatDataset([original_train_dataset, transformed_tokenized_dataset])
